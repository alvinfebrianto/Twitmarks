...
describe("CustomEmbeddedTweet", () => {
  ...
  it("renders a playable inline video through the tweet media proxy using a 720p mp4 when available", () => {
    ...
    expect(source).toHaveAttribute(
      "src",
      "/api/tweet/media?url=https%3A%2F%2Fvideo.twimg.com%2Famplify_video%2F2044772239510511616%2Fvid%2Favc1%2F720x900%2F1L4QMvB8e1UwdQ-i.mp4"
    );
  });
